    ...
    <section id="contact" className="relative w-full py-32 bg-primary px-6 md:px-16 overflow-hidden z-20 flex items-center justify-center text-center">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
         <motion.h2 
           ...
           viewport={{ once: true }}
           className="font-display text-4xl md:text-7xl lg:text-8xl uppercase text-white leading-none mb-10"
         >
         ...
         <motion.p 
            ...
            viewport={{ once: true }}
            className="font-sans text-[15px] md:text-2xl text-white/90 mb-12 max-w-2xl mx-auto"
         >
